...
export class GridsterItemComponent implements OnInit, OnDestroy, GridsterItemComponentInterface {
  ...
  notPlaced: boolean;
  init: boolean;
  showResizeHandles: boolean = false;
  ...
  ngOnInit(): void {
    ...
    this.gridster.renderer.listen(this.el, 'mouseenter', this.onMouseEnter.bind(this));
    this.gridster.renderer.listen(this.el, 'mouseleave', this.onMouseLeave.bind(this));
    this.gridster.renderer.listen(this.el, 'mousedown', this.onMouseDown.bind(this));
  }
