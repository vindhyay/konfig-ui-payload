...
export class GridsterDraggable {
  ...
  // Newly added start
  dragLeaveFunction: (event: any) => void;
  dragEnterFunction: (event: any) => void;
  // Newly added end
  mousemove: () => void;
  mouseup: () => void;
  mouseleave: () => void;
  ...
  constructor(
    ...
    this.path = [];
    // Newly added start
    this.dragLeaveFunction = this.dragLeave.bind(this);
    this.dragEnterFunction = this.dragEnter.bind(this);
    // Newly added end
    // Newly added start
    this.dragleave = this.gridster.renderer.listen(this.gridsterItem.el, 'dragleave', this.dragLeaveFunction);
    this.dragenter = this.gridster.renderer.listen(this.gridsterItem.el, 'dragenter', this.dragEnterFunction);
    // Newly added end
  }
