...
@Component({
  selector: "finlevit-lib-cascade-select",
  templateUrl: "./cascade-select.component.html",
  styleUrls: ["./cascade-select.component.scss"]
})
export class CascadeSelectComponent implements ControlValueAccessor, OnInit {
  ...
  @Input() childrenKey: string = "childElements";
  ...
  @Input() childKey: string = "childElements";
  @Input() optionGroupLabel: string = "name";
  _options = [];
  _value: any = null;
